...
import { PoweredByBadge } from "../components/PoweredBy";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Guerreiros Mentoria" },
      { name: "description", content: "Plataforma de mentoria de estudos." },
      { name: "author", content: "Guerreiros Mentoria" },
      { property: "og:title", content: "Guerreiros Mentoria" },
